...
- `docker/convert/` - TensorRT convert container Dockerfile
- `scripts/` - convert_engine.sh and utility scripts
- `docker-compose.yml` - 2-container Docker orchestration (model + convert)
...
- `docs/agent-guides/docker-deploy.md` - Docker 2-container deployment
